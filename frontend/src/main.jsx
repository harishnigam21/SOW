...
const RootProvider = () => {
  ...
  const Contain = {
    ...
    terms: {
      english: {
        name: "Terms",
        btn: "Close and Go Back",
        details: `BY clicking Invoice Now, you choose to register according to the information that you have typed in and the text on the registration page and the terms here, and you at the same time accept the terms here.
  ...
  Have a great day!`,
        notAvailable: "This Page is not visible on this device",
      },
      svenska: {
        name: "Villkor",
        btn: "Stäng och gå tillbaka",
        details: `GENOM ATT klicka på Fakturera Nu så väljer ni att registrera enligt den information som ni har lagt in och texten på registrerings sidan och villkoren här, och accepterar samtidigt villkoren här.
...
Ha en trevlig dag!`,
        notAvailable: "Den här sidan är inte synlig på den här enheten",
      },
    },
  };
  useEffect(() => {
  ...
  const router = createBrowserRouter([
    {
      ...
      element: (
        <App
          screen={screen}
          loginPageContain={Contain.loginPageContain}
